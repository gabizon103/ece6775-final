...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_r \
    op interface \
    ports { input_r_address0 { O 4 vector } input_r_ce0 { O 1 bit } input_r_q0 { I 10 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_max_id_V_out \
    op interface \
    ports { max_id_V_out { O 4 vector } max_id_V_out_ap_vld { O 1 bit } } \
} "
}
